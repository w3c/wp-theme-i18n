...
function twentyten_setup() {
	...
	define( 'HEADER_IMAGE', '%s/images/headers/w3c-header.jpg' );
		...
		<div class="comment-head">
			...
			<div class="comment-meta commentmetadata">
				...
				<?php
					...
					printf( __( '%1$s', 'twentyten' ), get_comment_date(),  get_comment_time() ); ?></span></a><?php edit_comment_link( __( '(Edit)', 'twentyten' ), ' ' );
				?>
...
function twentyten_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'First Footer Wide Widget Area', 'twentyten' ),
		'id' => 'first-footer-wide-widget-area',
		'description' => __( 'The first footer wide widget area', 'twentyten' ),
		'before_widget' => '<aside id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<header><h3 class="widget-title">',
		'after_title' => '</h3></header>',
	...
	// Area 8, located at the top of the page, right after the description.
	register_sidebar( array(
